...
<template>
  <div class="flex flex-col items-center justify-center min-h-[78vh] px-4">
    ...
    <div class="text-center mb-10">
      ...
      <h2 class="text-4xl font-bold mb-3 text-gray-900 tracking-tight">
    ...
    >
      <input
        ...
        class="flex-1 px-4 py-3 rounded-xl glass-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0071e3]/30 transition text-sm"
      />
      <button
        type="submit"
    ...
    <div class="flex gap-2 mt-5 flex-wrap justify-center">
      ...
      <button
        ...
        :key="hint"
        @click="username = hint; handleSearch()"
        class="text-xs px-3 py-1.5 rounded-full glass-sm text-gray-600 hover:text-[#0071e3] transition cursor-pointer"
      >
        {{ hint }}
      </button>
    </div>
